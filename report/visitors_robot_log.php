...
* module: Centcount Analytics Free Robot Log PHP Code *
* version: 1.00 Free *
* author: WM Jonssen *
* date: 03/12/2018 *
...
function visitors_robot_log_html() {
		...
		<div class="frameinner">
			<div class="innertable">
				<div class="innertitle">
					<span>'. $GLOBALS['indicator']['Robot Log'] .'</span>
					<a id="RobotLogTB_R" href="" class="ca_refresh_btn"></a>
				</div>
				<div id="RobotLogTB" class="innerbody">
			
				</div>
				<div class="innerfoot">
					<a id="RobotLogTB_TB"  href="" class="ca_table_btn" alt="table" title="table"></a>
					<a id="RobotLogTB_ALL" href="" class="ca_all_btn" alt="show all data" title="show all data"></a>
				</div>
			</div>
		</div>
	</div>';
...
<script type="text/javascript">
	...
	Refresh();
	function Refresh() {
		RobotLogTB = new LOGAPI('.$GLOBALS['SITEID'].', '.$_SESSION['r'].', VisitorsAPI.from, VisitorsAPI.to, 0, 2,"'.get_site_info('TimeZone').'", 1, 0, 2, "'.$_SESSION['DATACENTER'].'", "RobotLogTB", 0, 0, 0, LAN, ' .(date_offset_get(new DateTime) / 3600). ');
		RobotLogTB.run();
	}

...
* module: Centcount Analytics Free Action Exit-Page PHP Code *
* version: 1.00 Free *
* author: WM Jonssen *
* date: 03/12/2018 *
...
function actions_exit_page_html() {
		...
		<div class="frameinner">
			<div class="innertable">
				<div class="innertitle">
					<span>'. $GLOBALS['indicator']['Exit Pages'] .'</span>
					<a id="ExitPagesTB_R" href="" class="ca_refresh_btn"></a>
				</div>
				<div id="ExitPagesTB" class="innerbody">
			
				</div>
				<div class="innerfoot">
					<a id="ExitPagesTB_TB"  href="" class="ca_table_btn" alt="table" title="table"></a>
					<a id="ExitPagesTB_ALL" href="" class="ca_all_btn" alt="show all data" title="show all data"></a>
					<a id="ExitPagesTB_PIE" href="" class="ca_pie_btn" alt="pie" title="pie"></a>
					<a id="ExitPagesTB_BAR" href="" class="ca_bar_btn" alt="bar" title="bar"></a>
				</div>
			</div>
		</div>
	</div>';
...
<script type="text/javascript">
	...
	Refresh();
	function Refresh() {
		ExitPagesTB = new CHARTAPI('.$GLOBALS['SITEID'].', '.$_SESSION['r'].', VisitorsAPI.from, VisitorsAPI.to, 0, 65,"'.get_site_info('TimeZone').'", 13, 0, 0, "'.$_SESSION['DATACENTER'].'", "ExitPagesTB", 0, 0, 0, "'.$_SESSION['lan'].'", LAN);
		ExitPagesTB.run(0);
	}

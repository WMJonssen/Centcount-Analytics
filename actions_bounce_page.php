...
* module: Centcount Analytics Free Action Bounce-Page PHP Code *
* version: 1.00 Free *
* author: WM Jonssen *
* date: 03/12/2018 *
...
function actions_bounce_page_html() {
		...
		<div class="frameinner">
			<div class="innertable">
				<div class="innertitle">
					<span>'. $GLOBALS['indicator']['Bounce Pages'] .'</span>
					<a id="BouncePagesTB_R" href="" class="ca_refresh_btn"></a>
				</div>
				<div id="BouncePagesTB" class="innerbody">
			
				</div>
				<div class="innerfoot">
					<a id="BouncePagesTB_TB"  href="" class="ca_table_btn" alt="table" title="table"></a>
					<a id="BouncePagesTB_ALL" href="" class="ca_all_btn" alt="show all data" title="show all data"></a>
					<a id="BouncePagesTB_PIE" href="" class="ca_pie_btn" alt="pie" title="pie"></a>
					<a id="BouncePagesTB_BAR" href="" class="ca_bar_btn" alt="bar" title="bar"></a>
				</div>
			</div>
		</div>
	</div>';
...
<script type="text/javascript">
	...
	Refresh();
	function Refresh() {
		BouncePagesTB = new CHARTAPI('.$GLOBALS['SITEID'].', '.$_SESSION['r'].', VisitorsAPI.from, VisitorsAPI.to, 0, 64,"'.get_site_info('TimeZone').'", 16, 0, 0, "'.$_SESSION['DATACENTER'].'", "BouncePagesTB", 0, 0, 0, "'.$_SESSION['lan'].'", LAN);
		BouncePagesTB.run(0);
	}
	
	function Resize() {
		setTimeout(function(){
			BouncePagesTB.resize();
		}, 500);
	}

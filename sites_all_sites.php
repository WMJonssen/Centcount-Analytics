...
* module: Centcount Analytics Free Manage Sites PHP Code *
* version: 1.00 Free *
* author: WM Jonssen *
* date: 03/12/2018 *
		...
		if (i) {
			...
			for (var row = 0; row < i; row++) {
				tabletext += 
					...
					"<td class=\"tdmidnoborder\" ><a class=\"taba\" href=\"" + SITES[row]["Url"] + "&menu=Sites&action=Get Code\">" + LAN["JS Code"] + "</a></td>" +

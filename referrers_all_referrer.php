...
function referrers_all_referrer_html() {
		...
		<div class="frameinner">
			<div class="innertable">
				<div class="innertitle">
					<span>'. $GLOBALS['indicator']['All Referrers'] .'</span>
					<a id="AllReferrersTB_R" href="" class="ca_refresh_btn"></a>
				</div>
				<div id="AllReferrersTB" class="innerbody">
					
				</div>
				<div class="innerfoot">
					<a id="AllReferrersTB_TB"  href="" class="ca_table_btn" alt="table" title="table"></a>
					<a id="AllReferrersTB_ALL" href="" class="ca_all_btn" alt="show all data" title="show all data"></a>
					<a id="AllReferrersTB_PIE" href="" class="ca_pie_btn" alt="pie" title="pie"></a>
					<a id="AllReferrersTB_BAR" href="" class="ca_bar_btn" alt="bar" title="bar"></a>
				</div>
			</div>
		</div>
	</div>';
...
<script type="text/javascript">
	...
	Refresh();
	function Refresh() {
		AllReferrersTB = new CHARTAPI('.$GLOBALS['SITEID'].', '.$_SESSION['r'].', VisitorsAPI.from, VisitorsAPI.to, 0, 67,"'.get_site_info('TimeZone').'", 1, 0, 0, "'.$_SESSION['DATACENTER'].'", "AllReferrersTB", 0, 0, 0, "'.$_SESSION['lan'].'", LAN);
		AllReferrersTB.run(0);
	}
	
	function Resize() {
		setTimeout(function(){
			AllReferrersTB.resize();
		}, 500);
	}
